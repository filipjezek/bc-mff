...
% Po diskuzi s členy CSNG byly formovány následující požadavky na vizualizační aplikaci:

% \begin{enumerate}
%   \item Možnost výběru datastore z potenciálně více nakonfigurovaných adresářů
%   \item Přehledný výběr a filtrování datových struktur
%   \item Rozšiřitelnost, důkladné testy a dokumentace
% \end{enumerate}
